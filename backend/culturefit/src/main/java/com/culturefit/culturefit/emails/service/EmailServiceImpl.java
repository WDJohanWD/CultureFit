...
public class EmailServiceImpl implements EmailService{
    ...
    public boolean sendConfirmationEmail(String toEmail) {
        ...
        try {
            ...
            helper.setText("<div style='background-color: #FF5400; padding: 20px; text-align: center;'>"
                    ...
                    + "<a href='" + confirmationUrl + "' style='display: inline-block; padding: 10px 20px; color: white; background-color: #FF5400; text-decoration: none; border-radius: 5px; font-weight: bold; font-family: Montserrat, Arial, sans-serif;'>Confirm account</a>"
                    + "</div>", true);
            sender.send(message); 
            return true;
        } catch (MessagingException e) { e.printStackTrace(); return false; }
